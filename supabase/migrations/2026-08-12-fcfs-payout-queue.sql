...
DROP FUNCTION IF EXISTS public.claim_spin(date, text, text, text, text, integer, jsonb, boolean, integer, boolean, integer); -- LIVE 11-arg (cooldown/carryover)
...
REVOKE ALL ON FUNCTION public.claim_spin(date, text, text, text, text, integer, jsonb, boolean, integer, boolean, integer, text, jsonb) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.claim_spin(date, text, text, text, text, integer, jsonb, boolean, integer, boolean, integer, text, jsonb) FROM anon, authenticated;
GRANT EXECUTE ON FUNCTION public.claim_spin(date, text, text, text, text, integer, jsonb, boolean, integer, boolean, integer, text, jsonb) TO service_role;
